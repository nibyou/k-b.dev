...
const Footer = () => {
  ...
  }, isDark ? `Hell` : `Dunkel`), "Copyright \xA9 ", new Date().getFullYear(), ". Alle Rechte vorberhalten.", (0,theme_ui__WEBPACK_IMPORTED_MODULE_2__.jsx)("br", null), (0,theme_ui__WEBPACK_IMPORTED_MODULE_2__.jsx)(theme_ui__WEBPACK_IMPORTED_MODULE_3__.Flex, {
    sx: {
      justifyContent: `center`,
      alignItems: `center`,
      mt: 3,
